						...
						<ul class="tickets">
							<li class="ticket">
								<a href="#">
									...
									<span class="content">
										<span class="avatar"><img src="{$baseUrl}assets/img/avatar6.jpg" alt="Avatar"></span>
						  	...
						  	<li class="ticket">
								<a href="#">
									...
									<span class="content">
										<span class="avatar"><img src="{$baseUrl}assets/img/avatar7.jpg" alt="Avatar"></span>
							...
							<li class="ticket">
								<a href="#">
									...
									<span class="content">
										<span class="avatar"><img src="{$baseUrl}assets/img/avatar8.jpg" alt="Avatar"></span>
							...
							<li class="ticket">
								<a href="#">
									...
									<span class="content">
										<span class="avatar"><img src="{$baseUrl}assets/img/avatar9.jpg" alt="Avatar"></span>
				...
				<div class="box span4" onTablet="span6" onDesktop="span4">
					...
					<div class="box-content">
						<ul class="dashboard-list">
							<li>
								<a href="#">
									<img class="avatar" alt="Lucas" src="{$baseUrl}assets/img/avatar.jpg">
								</a>
							...
							<li>
								<a href="#">
									<img class="avatar" alt="Bill" src="{$baseUrl}assets/img/avatar9.jpg">
								</a>
							...
							<li>
								<a href="#">
									<img class="avatar" alt="Jane" src="{$baseUrl}assets/img/avatar5.jpg">
								</a>
							...
							<li>
								<a href="#">
									<img class="avatar" alt="Kate" src="{$baseUrl}assets/img/avatar6.jpg">
								</a>
