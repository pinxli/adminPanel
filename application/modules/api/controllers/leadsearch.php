...
##==================================================
## API Controller for Lead Search
## @Author: Pinky Liwanagan
## @Date: 07-NOV-2013 
##==================================================

class Leadsearch extends CI_Controller {
	...
	public function get()
	{
		...
		if ( $is_valid_auth['rc'] == 0 ){
			...
			if ( $this->leadsId != '' ){
				...
				//get list of leads
				$response = $this->leads_model->leadSearchList();
			}
		}
		else{
		...
		$log_data = array(
			...
			'log_method' 	=> 'LEAD SEARCH - '.$_SERVER['REQUEST_METHOD'],
		...
		$this->api_functions->apiLog(json_encode($log_data),'GET_LEADSEARCH'); //text logs
